...
$__dart_deferred_initializers__.current=function(a,b,c,d,e,f,g,h,i,j,k,l,m,$){var C={},H={},J={},P={},W={},G={},Y={},R={},K={},V={},S={},N={},E={},M={em:function em(n,o,p,q,r,s,t,u,v,w,x){var _=this
_.id=n
_.z=o
_.Q=p
_.ch=q
...
_.a$=w
_.a=x}},B={},Q={},D={},L={
pm:function(n,o){var x,w
x=new L.TL(P.i(P.d,null),n)
x.a=S.j(x,1,C.j,o,M.em)
w=document.createElement("material-fab")
H.a(w,"$isF")
x.e=w
w.setAttribute("animated","true")
w=$.ae7
if(w==null){w=$.O
w=w.a1(null,C.p,$.$get$apw())
$.ae7=w}x.a0(w)
return x},
aMJ:function(n,o){var x=new L.a0z(P.i(P.d,null),n)
x.a=S.j(x,3,C.k,o,M.em)
return x},
aao:function(){if($.ake)return
$.ake=!0
$.$get$R().q(0,C.nj,C.hp)
O.a9Z()
E.G()
...
_.c=o
_.f=_.e=_.d=null},
a0z:function a0z(n,o){var _=this
_.a=_.x=_.r=null
_.b=n
_.c=o
...
ga22:function(){return this.ch||this.z||this.Q}}
L.TL.prototype={
...
this.y.k(0,u,[])
u=W.N
J.W(this.x,"mousedown",this.w(J.ab4(this.f),u,u))
J.W(this.x,"mouseup",this.w(J.ab5(this.f),u,u))
this.P(C.a,null)
t=J.Y(w)
t.a7(w,"click",this.w(x.gdF(),u,W.ad))
t.a7(w,"keypress",this.w(x.gdz(),u,W.a_))
t.a7(w,"mousedown",this.w(x.gi9(x),u,u))
t.a7(w,"mouseup",this.w(x.gjA(x),u,u))
s=W.a9
t.a7(w,"focus",this.w(x.geM(x),u,s))
t.a7(w,"blur",this.w(x.geA(x),u,s))
return},
t:function(){this.y.j()},
v:function(){var x=this.y
if(!(x==null))x.i()
this.z.W()},
C:function(n){var x,w,v,u,t,s,r,q,p
x=J.mM(this.f)
w=this.Q
if(w==null?x!=null:w!==x){this.e.tabIndex=x
this.Q=x}v=this.f.gkF()
w=this.ch
if(w==null?v!=null:w!==v){w=this.e
this.a9(w,"role",v==null?null:v)
this.ch=v}u=this.f.gjn()
w=this.cx
if(w!==u){w=this.e
this.a9(w,"aria-disabled",u)
this.cx=u}t=J.fj(this.f)
w=this.cy
if(w==null?t!=null:w!==t){this.bb(this.e,"is-disabled",t)
this.cy=t}s=this.f.gnk()
w=this.db
if(w==null?s!=null:w!==s){w=this.e
this.a9(w,"disabled",s==null?null:s)
this.db=s}r=this.f.gxH()
w=this.dx
if(w==null?r!=null:w!==r){w=this.e
this.a9(w,"raised",r==null?null:r)
this.dx=r}q=this.f.gxG()
w=this.dy
if(w!==q){this.bb(this.e,"is-focused",q)
this.dy=q}p=this.f.ga22()
w=this.fr
if(w!==p){this.bb(this.e,"is-pressed",p)
this.fr=p}},
$asc:function(){return[M.em]}}
L.a0z.prototype={
...
this.e=w
v=x.a.b
w=new M.em(v,!1,!1,!1,!1,new P.m(null,null,0,[W.a9]),null,!1,!0,null,w)
this.x=w
x.k(0,w,this.a.e)
this.D(this.e)
return new D.K(this,0,this.e,this.x,[M.em])},
