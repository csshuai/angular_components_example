...
this.x=w
this.l(w)
v=x.createTextNode("A default toggle button")
...
this.cy=u
this.l(u)
t=x.createTextNode("Toggle buttons with label")
...
this.x1=u
this.l(u)
s=x.createTextNode("Toggle buttons that interact with each other")
...
this.H=u
this.l(u)
r=x.createTextNode("Toggle buttons with different theme colors (using mixins)")
this.H.appendChild(r)
u=S.l(x,this.L)
this.a_=u
u.className="theme-red"
this.h(u)
u=Q.cp(this,25)
this.V=u
u=u.e
...
u=S.l(x,this.L)
this.S=u
u.className="theme-purple"
this.h(u)
u=Q.cp(this,27)
this.ab=u
u=u.e
this.ac=u
this.S.appendChild(u)
...
this.an=u
this.l(u)
q=x.createTextNode("Custom theme")
...
this.aD=u
this.l(u)
p=x.createTextNode("primary-color: $mat-light-green-500, off-btn-color: $mat-lime-500")
this.aD.appendChild(p)
u=S.l(x,this.af)
this.aA=u
u.className="custom-theme"
this.h(u)
u=Q.cp(this,39)
this.av=u
u=u.e
...
this.aN=u
this.l(u)
o=x.createTextNode("Toggle label on right")
this.aN.appendChild(o)
u=S.l(x,this.af)
this.aM=u
u.className="flip-label"
this.h(u)
u=Q.cp(this,43)
this.aE=u
u=u.e
...
if(y&&12===o)return this.k3
if(y&&14===o)return this.rx
if(y&&18===o)return this.y2
if(y&&20===o)return this.K
if(y&&25===o)return this.Z
if(y&&27===o)return this.a9
...
y=this.f
x=this.a.cy===0
if(x){this.dy.e="Toggle button 1"
w=!0}else w=!1
if(w)this.dx.a.st(1)
if(x){v=this.go
v.b=!1
...
v=y.a
u=v?"OFF":"ON"
t="Tap to turn Bluetooth "+u+"."
if(this.aB!==t){this.y2.e=t
this.aB=t
w=!0}u=this.aG
...
s=!y.a
if(this.ax!==s){this.K.b=s
this.ax=s
w=!0}else w=!1
v=y.b
u=v?"invisible":"visible"
...
if(w)this.aE.a.st(1)
q=Q.I(y.c)
if(this.as!==q){this.ch.textContent=q
this.as=q}this.z.j()
this.dx.j()
this.fy.j()
this.k2.j()
