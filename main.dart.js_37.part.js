...
w=S.b(x,"h2",w)
this.x=w
w.appendChild(x.createTextNode("Flat"))
w=U.U(this,3)
this.z=w
w=w.e
this.y=w
...
w=this.c
v=F.Q(w.m(C.q,this.a.Q,null))
this.Q=v
v=B.T(this.y,v,this.z.a.b,null)
this.ch=v
u=x.createTextNode("Default")
this.z.k(0,v,[[u]])
v=U.U(this,5)
this.cy=v
v=v.e
...
this.cx.className="red"
v=F.Q(w.m(C.q,this.a.Q,null))
this.db=v
v=B.T(this.cx,v,this.cy.a.b,null)
this.dx=v
t=x.createTextNode("Colored")
this.cy.k(0,v,[[t]])
v=U.U(this,7)
this.fr=v
v=v.e
this.dy=v
this.r.appendChild(v)
this.dy.setAttribute("disabled","")
v=F.Q(w.m(C.q,this.a.Q,null))
this.fx=v
v=B.T(this.dy,v,this.fr.a.b,null)
this.fy=v
s=x.createTextNode("Disabled")
this.fr.k(0,v,[[s]])
v=U.U(this,9)
this.id=v
v=v.e
this.go=v
this.r.appendChild(v)
this.go.setAttribute("compact","")
v=F.Q(w.m(C.q,this.a.Q,null))
this.k1=v
v=B.T(this.go,v,this.id.a.b,null)
this.k2=v
r=x.createTextNode("Compact")
this.id.k(0,v,[[r]])
v=S.b(x,"section",y)
this.k3=v
v.className="margin"
v=S.b(x,"h2",v)
this.k4=v
v.appendChild(x.createTextNode("Raised"))
v=U.U(this,14)
this.r2=v
v=v.e
this.r1=v
...
v=F.Q(w.m(C.q,this.a.Q,null))
this.rx=v
v=B.T(this.r1,v,this.r2.a.b,null)
this.ry=v
q=x.createTextNode("Raised")
this.r2.k(0,v,[[q]])
v=U.U(this,16)
this.x2=v
v=v.e
...
v=F.Q(w.m(C.q,this.a.Q,null))
this.y1=v
v=B.T(this.x1,v,this.x2.a.b,null)
this.y2=v
p=x.createTextNode("Colored")
this.x2.k(0,v,[[p]])
v=U.U(this,18)
this.O=v
v=v.e
this.T=v
this.k3.appendChild(v)
this.T.setAttribute("disabled","")
this.T.setAttribute("raised","")
v=F.Q(w.m(C.q,this.a.Q,null))
this.U=v
v=B.T(this.T,v,this.O.a.b,null)
this.K=v
o=x.createTextNode("Disabled")
this.O.k(0,v,[[o]])
v=U.U(this,20)
this.H=v
v=v.e
this.L=v
this.k3.appendChild(v)
this.L.setAttribute("dense","")
this.L.setAttribute("raised","")
v=F.Q(w.m(C.q,this.a.Q,null))
this.a_=v
v=B.T(this.L,v,this.H.a.b,null)
this.a2=v
n=x.createTextNode("Dense")
this.H.k(0,v,[[n]])
v=U.U(this,22)
this.Z=v
v=v.e
this.V=v
this.k3.appendChild(v)
this.V.setAttribute("compact","")
this.V.setAttribute("raised","")
v=F.Q(w.m(C.q,this.a.Q,null))
this.S=v
v=B.T(this.V,v,this.Z.a.b,null)
this.ac=v
a0=x.createTextNode("Compact")
this.Z.k(0,v,[[a0]])
v=S.b(x,"section",y)
this.ab=v
v.className="margin"
v=S.b(x,"h2",v)
this.a9=v
v.appendChild(x.createTextNode("Icons"))
v=U.U(this,27)
this.ad=v
v=v.e
this.aa=v
this.ab.appendChild(v)
this.aa.setAttribute("icon","")
v=F.Q(w.m(C.q,this.a.Q,null))
this.al=v
this.ah=B.T(this.aa,v,this.ad.a.b,null)
v=M.Y(this,28)
this.Y=v
v=v.e
this.ak=v
v.setAttribute("icon","check")
v=new Y.R(null,this.ak)
this.ap=v
this.Y.k(0,v,[])
this.ad.k(0,this.ah,[[this.ak]])
v=U.U(this,29)
this.af=v
v=v.e
this.ar=v
this.ab.appendChild(v)
v=this.ar
v.className="blue-icon"
v.setAttribute("icon","")
v=F.Q(w.m(C.q,this.a.Q,null))
this.an=v
this.au=B.T(this.ar,v,this.af.a.b,null)
v=M.Y(this,30)
this.aA=v
v=v.e
this.aD=v
v.setAttribute("icon","favorite")
v=new Y.R(null,this.aD)
this.aL=v
this.aA.k(0,v,[])
this.af.k(0,this.au,[[this.aD]])
v=U.U(this,31)
this.aw=v
v=v.e
this.av=v
this.ab.appendChild(v)
this.av.setAttribute("icon","")
v=F.Q(w.m(C.q,this.a.Q,null))
this.aN=v
this.aM=B.T(this.av,v,this.aw.a.b,null)
v=M.Y(this,32)
this.aE=v
v=v.e
this.aH=v
...
this.as=v
this.ab.appendChild(v)
this.as.setAttribute("icon","")
this.as.setAttribute("vertical","")
...
if(y)this.ac.E()
if(y)this.ah.E()
if(y){this.ap.sai(0,"check")
x=!0}else x=!1
if(x)this.Y.a.st(1)
if(y)this.au.E()
if(y){this.aL.sai(0,"favorite")
x=!0}else x=!1
if(x)this.aA.a.st(1)
if(y)this.aM.E()
...
this.r=w
this.l(w)
v=x.createTextNode("Material Button")
this.r.appendChild(v)
y.appendChild(x.createTextNode("\n\n"))
w=S.l(x,y)
this.x=w
...
this.ch=w
this.l(w)
q=x.createTextNode("Light Theme")
...
this.fx=w
this.l(w)
a1=x.createTextNode("Dark Theme")
...
this.k2=w
this.l(w)
a8=x.createTextNode("Custom text")
...
this.h(this.k3)
w=this.c
b0=F.Q(w.m(C.q,this.a.Q,null))
this.r1=b0
b0=B.T(this.k3,b0,this.k4.a.b,null)
this.r2=b0
b1=x.createTextNode("")
this.rx=b1
this.k4.k(0,b0,[[b1]])
...
this.x2=b1
b1=B.T(this.ry,b1,this.x1.a.b,null)
this.y1=b1
b3=x.createTextNode("Colored ")
b0=x.createTextNode("")
this.y2=b0
this.x1.k(0,b1,[[b3,b0]])
b4=x.createTextNode("\n    ")
...
b0=F.Q(w.m(C.q,this.a.Q,null))
this.U=b0
b0=B.T(this.T,b0,this.O.a.b,null)
this.K=b0
b5=x.createTextNode("Disabled ")
b1=x.createTextNode("")
this.L=b1
this.O.k(0,b0,[[b5,b1]])
b6=x.createTextNode("\n  ")
...
this.a_=b1
this.l(b1)
b9=x.createTextNode("Disabled using mixin")
...
this.a2=b1
this.l(b1)
c1=x.createTextNode("Mixin is preferred over external CSS because it sets the right disabled color.")
this.a2.appendChild(c1)
c2=x.createTextNode("\n    ")
this.H.appendChild(c2)
b1=U.U(this,53)
this.Z=b1
b1=b1.e
this.V=b1
...
b1=this.V
b1.className="red disabled"
b1.setAttribute("raised","")
this.h(this.V)
b1=F.Q(w.m(C.q,this.a.Q,null))
this.S=b1
b1=B.T(this.V,b1,this.Z.a.b,null)
this.ac=b1
c3=x.createTextNode("button")
this.Z.k(0,b1,[[c3]])
c4=x.createTextNode("\n    ")
...
b1=F.Q(w.m(C.q,this.a.Q,null))
this.aa=b1
b1=B.T(this.ab,b1,this.a9.a.b,null)
this.ad=b1
c5=x.createTextNode("disabled")
this.a9.k(0,b1,[[c5]])
c6=x.createTextNode("\n    ")
this.H.appendChild(c6)
b1=S.b(x,"h2",this.H)
this.al=b1
this.l(b1)
c7=x.createTextNode("Disabled not using mixin")
this.al.appendChild(c7)
c8=x.createTextNode("\n    ")
this.H.appendChild(c8)
b1=U.U(this,62)
this.ak=b1
b1=b1.e
this.ah=b1
this.H.appendChild(b1)
b1=this.ah
b1.className="no-mixin-red"
b1.setAttribute("raised","")
this.h(this.ah)
b1=F.Q(w.m(C.q,this.a.Q,null))
this.Y=b1
b1=B.T(this.ah,b1,this.ak.a.b,null)
this.ap=b1
c9=x.createTextNode("button")
this.ak.k(0,b1,[[c9]])
d0=x.createTextNode("\n    ")
this.H.appendChild(d0)
b1=U.U(this,65)
this.af=b1
b1=b1.e
this.ar=b1
...
b1=F.Q(w.m(C.q,this.a.Q,null))
this.an=b1
b1=B.T(this.ar,b1,this.af.a.b,null)
this.au=b1
d1=x.createTextNode("disabled")
this.af.k(0,b1,[[d1]])
d2=x.createTextNode("\n    ")
this.H.appendChild(d2)
b1=S.b(x,"h2",this.H)
this.aD=b1
this.l(b1)
d3=x.createTextNode("Raised using mixin")
this.aD.appendChild(d3)
d4=x.createTextNode("\n    ")
this.H.appendChild(d4)
b1=U.U(this,71)
this.aL=b1
b1=b1.e
this.aA=b1
this.H.appendChild(b1)
b1=this.aA
b1.className="raised-example"
this.h(b1)
b1=F.Q(w.m(C.q,this.a.Q,null))
this.av=b1
b1=B.T(this.aA,b1,this.aL.a.b,null)
this.aw=b1
d5=x.createTextNode("Raised Mixin")
this.aL.k(0,b1,[[d5]])
d6=x.createTextNode("\n    ")
this.H.appendChild(d6)
b1=U.U(this,74)
this.aM=b1
b1=b1.e
this.aN=b1
...
b1=F.Q(w.m(C.q,this.a.Q,null))
this.aH=b1
b1=B.T(this.aN,b1,this.aM.a.b,null)
this.aE=b1
d7=x.createTextNode("Disabled Raised")
this.aM.k(0,b1,[[d7]])
d8=x.createTextNode("\n    ")
this.H.appendChild(d8)
b1=U.U(this,77)
this.as=b1
b1=b1.e
this.aV=b1
...
this.aq.k(0,b1,[[e1]])
e2=x.createTextNode("\n    ")
this.H.appendChild(e2)
b1=S.b(x,"h2",this.H)
this.ay=b1
this.l(b1)
e3=x.createTextNode("Dense using mixin")
this.ay.appendChild(e3)
e4=x.createTextNode("\n    ")
this.H.appendChild(e4)
b1=U.U(this,86)
this.aF=b1
b1=b1.e
this.bb=b1
...
this.bQ=b1
this.l(b1)
f3=x.createTextNode("Raised and highlighted")
this.bQ.appendChild(f3)
f4=x.createTextNode("\n    ")
...
this.bp=b1
this.l(b1)
g3=x.createTextNode("Regular")
this.bp.appendChild(g3)
g4=x.createTextNode("\n    ")
...
b1=this.bM
b1.className="red"
b1.setAttribute("clear-size","")
this.bM.setAttribute("raised","")
this.h(this.bM)
b1=F.Q(w.m(C.q,this.a.Q,null))
this.bA=b1
b1=B.T(this.bM,b1,this.bN.a.b,null)
this.bu=b1
h1=x.createTextNode("button")
this.bN.k(0,b1,[[h1]])
h2=x.createTextNode("\n    ")
this.b1.appendChild(h2)
b1=U.U(this,128)
this.cb=b1
b1=b1.e
this.bB=b1
...
this.cb.k(0,w,[[h3]])
h4=x.createTextNode("\n  ")
this.b1.appendChild(h4)
h5=x.createTextNode("\n\n  ")
this.x.appendChild(h5)
w=S.b(x,"section",this.x)
this.bC=w
w.className="margin"
this.l(w)
...
this.l(w)
h7=x.createTextNode("\n      ")
this.b2.appendChild(h7)
w=S.b(x,"strong",this.b2)
this.bv=w
this.l(w)
h8=x.createTextNode("F")
...
this.bT=w
this.l(w)
i2=x.createTextNode("B")
this.bT.appendChild(i2)
i3=x.createTextNode("utton\n    ")
...
j4=x.createTextNode("\n")
this.x.appendChild(j4)
y.appendChild(x.createTextNode("\n"))
this.N(C.a,null)
return},
P:function(n,o,p){var y,x
if(n===C.q&&18<=o&&o<=24){y=this.fr
if(y==null){this.fr=!0
...
u=y.a
if(u==null)u=""
if(this.bP!==u){this.rx.textContent=u
